...
`,g=s(m)`
  height: 100%;
  padding: 0.3rem;
  animation: ${f} 0.4s ease-in-out infinite;
  border-color: rgba(222, 222, 222, 0.2);
  &:before,
  &:after {
    opacity: 0.5;
  }
`,x=/[\u4e00-\u9fa5]/g,n=[...new Set(u.join("").match(x).join("").split(""))].join("").substring(0,100);let a=0;function w({visible:i=!1,handleDone:r}){const d=t=>{let e=Math.floor(Math.random()*n.length),l=n[e];t.target.innerHTML=l};return c.useEffect(()=>(a=setTimeout(()=>{r()},1500),()=>{clearTimeout(a)}),[r]),o.jsx(h,{className:i?"visible":"hidden",children:o.jsx("div",{className:"words",children:n.split("").map((t,e)=>o.jsx(g,{onAnimationIteration:i?d:null,style:{animationDuration:`${2*Math.random()+.2}s`},children:t},`${t}-${e}`))})})}export{w as default};
