import{r as s,R as n,_ as d,j as e,d as l}from"./index-DkB9s-eS.js";import{b as c,d as h,S as m}from"./index-Dumjtcjk.js";import{j as p}from"./animates-BCuKWKzD.js";class a extends s.PureComponent{constructor(t){super(t),this.$=n.createRef(),this._=n.createRef()}render(){return n.createElement("span",{ref:this.$},n.createElement("a",{...this.props,ref:this._},this.props.children))}componentDidMount(){this.paint()}getSnapshotBeforeUpdate(){return this.reset(),null}componentDidUpdate(){this.paint()}componentWillUnmount(){this.reset()}paint(){const t=this.$.current.appendChild(document.createElement("span"));d(async()=>{const{render:i}=await import("./buttons.esm-DK2fWHEW.js");return{render:i}},[],import.meta.url).then(({render:i})=>{this._.current!=null&&i(t.appendChild(this._.current),function(o){try{t.parentNode.replaceChild(o,t)}catch{}})})}reset(){this.$.current.replaceChild(this._.current,this.$.current.lastChild)}}const u=""+new URL("reward-Z5L4CcqZ.jpg",import.meta.url).href,g=l(m)`
  position: fixed;
  right: 0.5rem;
  bottom: 0.5rem;
  margin-right: 0.5rem;
